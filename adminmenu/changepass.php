			...
			$query="update log_table set PASSWORD='$newpass' WHERE USERNAME='$user' ";
				$result=mysqli_query($con,$query);
				 echo "<script> alert('PASSWORD UPDATED SUCCESSFULLY'); 
						...
						window.location.href='adminmenu_1.php';</script>";
                            //session_destroy();
...
<br><br>
		<button class="btn btn-info" type="Submit" name="change">Change</button><br><br>
        <a href="\project2019-2020\AdminPanel\MENU\adminmenu_1.php"><input type="button" class="btn btn-info" value="Exit"></a>
	</form>
